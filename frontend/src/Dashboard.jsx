...
//             {/* Input Form */}
//             <div className="bg-white rounded-lg shadow p-6">
//               <h3 className="text-xl font-bold mb-4">Enter Environmental Parameters</h3>
//               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                 <input
//                   type="number"
...
//               <button
//                 onClick={handleCropRecommendation}
//                 className="mt-4 bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700 font-semibold transition-colors"
//               >
//                 Get Recommendations
//               </button>
//             </div>
